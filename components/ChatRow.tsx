...
function ChatRow({
  ...
  return (
    <div
      className="group rounded-xl border border-gray-200/30 bg-white/50 backdrop-blur-sm hover:bg-white/80 transition-all duration-200 cursor-pointer"
      onClick={handleClick}
    >
      <div className="p-2">
      ...
      {/* Last Message */}
      {lastMessage && (
        <p className="text-xs text-gray-400 pt-1.5 pb-2 ml-2 font-medium">
